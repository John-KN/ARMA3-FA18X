class FA18X_LOADOUT_SELECT_UI 
{
	...
	class Controls 
	{
		...
		{
			idc = 1204;
			text = "\js_s_fa18x\UI\FA18X_GUI_arming_menu_SELECT.paa";
		...
		class FA18_SELECT_EWP_BUTTON_1601: FA18X_RscButtonMenu
		{
			idc = 1601;
			x = 0.26246 * safezoneW + safezoneX;
			y = 0.231142 * safezoneH + safezoneY;
			w = 0.212574 * safezoneW;
			h = 0.439743 * safezoneH;
			text = "";
			size = 0.023;
			tooltip = "Loadouts within External weapon pod";
			action = "[]Spawn JS_S_fnc_FA18X_LOADOUT_EWP_UI";
		};

		class FA18_SELECT_FULL_BUTTON_1602: FA18X_RscButtonMenu
		{
			idc = 1602;
			x = 0.520999 * safezoneW + safezoneX;
			y = 0.23114 * safezoneH + safezoneY;
			w = 0.212574 * safezoneW;
			h = 0.439743 * safezoneH;
			text = "";
			size = 0.023;
			tooltip = "Full loadout customization page";
			action = "[]Spawn JS_S_fnc_FA18X_LOADOUT_FULL_UI";
		};
