...
CreateDialog "FA18X_LOADOUT_FULL_UI";
	   ...
	   {lbAdd[3120,_x]} forEach [
		...
		((uiNamespace getVariable "myDisplay") displayCtrl 3120) lbSetCurSel 0;

	 	((uiNamespace getVariable "myDisplay") displayCtrl 3105) ctrlSetEventHandler ["LBSelChanged","[_FA18X]Spawn JS_S_fnc_FA18X_LOADOUT_RESTRICTIONS_3105"];
		((uiNamespace getVariable "myDisplay") displayCtrl 3106) ctrlSetEventHandler ["LBSelChanged","[_FA18X]Spawn JS_S_fnc_FA18X_LOADOUT_RESTRICTIONS_3106"];
		((uiNamespace getVariable "myDisplay") displayCtrl 3107) ctrlSetEventHandler ["LBSelChanged","[_FA18X]Spawn JS_S_fnc_FA18X_LOADOUT_RESTRICTIONS_3107"];
		((uiNamespace getVariable "myDisplay") displayCtrl 3108) ctrlSetEventHandler ["LBSelChanged","[_FA18X]Spawn JS_S_fnc_FA18X_LOADOUT_RESTRICTIONS_3108"];
